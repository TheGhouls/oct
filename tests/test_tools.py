...
class ToolsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sys.argv = sys.argv[:1]
        sys.argv += ["new", self.rebuild_project_dir]
        main()
    ...
    def test_convert_to_csv_success(self):
        ...
        sys.argv = sys.argv[:1]
        sys.argv += ["to-csv", self.results_file, self.output_file]
        main()
    ...
    def test_convert_to_csv_errors(self):
        ...
        with self.assertRaises(OSError):
            sys.argv = sys.argv[:1]
            sys.argv += ["to-csv", "bad_result_file", "/tmp/bad_results_file"]
            main()
    ...
    def test_parser(self):
        ...
        """
        sys.argv = sys.argv[:1]
        sys.argv += ["to-csv", self.results_file, self.output_file, "-d", ";"]
        main()
    ...
    def test_rebuild_results(self):
        ...
        """
        sys.argv = sys.argv[:1]
        sys.argv += ["rebuild", self.rebuild_dir, self.results_file, self.config_file]
        main()
